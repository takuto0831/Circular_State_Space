...
<div class="column3">
```{r include=FALSE}
load("fit/CircularAR_2.rda", verbose = TRUE) # load fit
```

```{r echo=FALSE}
pred_value(fit = fit_ar_2,p = 2,dat=wind_data$theta_real,who = 1,dif = FALSE)
```
...
```{r echo=FALSE}
data_frame(p = c(1,2,3,4,5,6,7),
           WAIC = c(890.1,888.2,888.8, 890.1,888.2,889.8,885.2),
...
<div class="column3">
```{r echo=FALSE}
pred_value(fit = fit_state_obs_2,p = 2,dat=wind_data$theta_real,dif = FALSE)
```
</div>
