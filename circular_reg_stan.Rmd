...
source('~/Desktop/circular_reg/script/stan_plot_label_helper.R') # stan_ac_labelに必要
source('~/Desktop/circular_reg/script/misc.R') # stan_ac_labelに必要
```
...
# fitting stan model
fit <- sampling(state_model,data = d.dat1, iter=1000, chains=1)
...
```{r}
# # model1
pred_value(fit = fit,p = 1,dat=wind_data$theta_real)
