...
```{r}
# state and observation
pred_value(fit = fit_state,p = 1,dat=wind_data$theta_real)
pred_value(fit = fit_state_atanh,p = 1,dat=wind_data$theta_real)
pred_value(fit = fit_obs,p = 1,dat=wind_data$theta_real)
pred_value(fit = fit_state_obs,p = 1,dat=wind_data$theta_real)
pred_value(fit = fit_state_obs_atanh,p = 1,dat=wind_data$theta_real)
```
...
```{r}
extract_log_lik(fit,"log_likelihood") %>%  loo::waic()
# model4
